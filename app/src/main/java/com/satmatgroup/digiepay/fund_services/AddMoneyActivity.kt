package com.satmatgroup.digiepay.fund_services
...
import com.satmatgroup.digiepay.activities_upi.PaymentSuccess
import com.satmatgroup.digiepay.activities_upi.Singleton2
...
class AddMoneyActivity : AppCompatActivity(), AppApiCalls.OnAPICallCompleteListener ,PaymentStatusListener {
    ...
    var upiid: String = "HDFCBALRAM98888@ybl"
...
//        tvUserNameNumber.setText("Transferring money to:\n${userModel.cus_name} (${userModel.cus_mobile}) ")
    ...
    private fun makePayment(
        ...
        val easyUpiPayment = EasyUpiPayment.Builder()
            ...
            .setPayeeVpa("HDFCBALRAM98888@ybl") // on below line we are setting name to which we are making oayment.
